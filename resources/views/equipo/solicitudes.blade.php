...
<div class="desktop-11-afC">
  <div class="desktop-3-vyx">
    ...
    <a href="#" class="pendientes-VKp">Pendientes</a>
    <a href="index" class="solicitudes-PRC">Almacen</a>
    <a href="rechazadas" class="rechazadas-3Er">Rechazadas</a>
    ...
    <p class="solicitud-oQn">
        <span class="solicitud-oQn-sub-0">SOLICI</span>
        <span class="solicitud-oQn-sub-1">TUDES</span>
      </p>
                                    ...
                                    <tbody>
                                        @foreach ($mensajes as $mensaje)
                                            <tr>
                                                ...
                                                <td>{{ $mensaje->usuario_id }}</td>
                                                <td>{{ $mensaje->equipo_id}}</td>
